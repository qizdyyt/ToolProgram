...
+ (void)testFuncWithFuncName:(NSString *)name type:(int)type {
    NSLog(@"%@,\n%@,\n%@,\n%@,\n%@,\n%@", DeviceInfoTool.getDeviceName, DeviceInfoTool.getiPhoneName, DeviceInfoTool.getSystemName,DeviceInfoTool.getAppVersion,DeviceInfoTool.getSystemVersion, DeviceInfoTool.getDeviceIPAddress);
    /*打印结果：
     iPhone 6 Plus,
     iPhone,
     iOS,
